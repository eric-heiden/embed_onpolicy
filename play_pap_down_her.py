...
@click.command()
@click.argument('policy_file', type=str, default="/home/eric/.deep-rl-docker/embed_onpolicy/log/reach_her_0_2018-07-26-01-27-14/policy_best.pkl")
