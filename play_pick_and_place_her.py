...
from run_pick_and_place_her import prepare_params
        ...
        for t in range(self.T):
            ...
            for i in range(self.rollout_batch_size):
                ...
                try:
                    ...
                    env = self.envs[i]  # type: TaskPickAndPlaceEnv
...
@click.command()
@click.argument('policy_file', type=str, default="/home/eric/.deep-rl-docker/embed_onpolicy/log/reach_her_0_2018-07-23-21-16-54/policy_best.pkl")
